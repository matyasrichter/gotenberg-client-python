...
T = TypeVar("T", bound="URLConversionRequestBody")


@attr.s(auto_attribs=True)
class URLConversionRequestBody:
    """
    Attributes:
        url (str):  Example: https://google.com.
        files (Union[Unset, List[File]]): Optional files named header.html and footer.html
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        url_conversion_request_body = cls(
            url=url,
            files=files,
        ...
        url_conversion_request_body.additional_properties = d
        return url_conversion_request_body
