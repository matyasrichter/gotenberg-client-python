...
T = TypeVar("T", bound="HTMLConversionRequestBody")


@attr.s(auto_attribs=True)
class HTMLConversionRequestBody:
    """
    Attributes:
        files (List[File]): List of HTML files to be converted to PDF. An `index.html` file is required, and any other
            resources that are referenced through the HTML file must be included as well. All the referenced files must be
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        html_conversion_request_body = cls(
            files=files,
        ...
        html_conversion_request_body.additional_properties = d
        return html_conversion_request_body
